      ...
      <div className="mt-6 flow-root">
        <div className="overflow-x-auto">
          <div className="min-w-full align-middle">
            <div className="rounded-md bg-gray-50 dark:bg-gray-800 p-2 md:pt-0">
              ...
              <table className="hidden min-w-full rounded-md text-gray-900 dark:text-white md:table">
                ...
                <tbody className="divide-y divide-gray-200 dark:divide-gray-600 text-gray-900 dark:text-white">
                  {customers.map((customer) => (
                    <tr key={customer.id} className="group">
                      <td className="whitespace-nowrap bg-white dark:bg-gray-700 py-5 pl-4 pr-3 text-sm text-black dark:text-white group-first-of-type:rounded-md group-last-of-type:rounded-md sm:pl-6">
                        <div className="flex items-center gap-3">
                          <Image
                            src={customer.image_url}
                            className="rounded-full"
                      ...
                      <td className="whitespace-nowrap bg-white dark:bg-gray-700 px-4 py-5 text-sm dark:text-gray-200">
                        {customer.email}
                      </td>
                      <td className="whitespace-nowrap bg-white dark:bg-gray-700 px-4 py-5 text-sm dark:text-gray-200">
